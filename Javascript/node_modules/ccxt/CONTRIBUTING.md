...
/py/                   # Python ccxt module/package folder for PyPI
/py/__init__.py        # entry point for the Python version of the ccxt.library
/py/async_support/     # asynchronous version of the ccxt.library for Python 3.5.3+ asyncio
/py/base/              # base code for the Python version of the ccxt library
/py/MANIFEST.in        # a PyPI-package file listing extra package files (license, configs, etc...)
/py/README.md          # a copy of README.md for PyPI
/py/setup.cfg          # wheels config file for the Python package
/py/setup.py           # pip/setuptools script (build/install) for ccxt in Python
/py/tox.ini            # tox config for Python
...
node run-tests --py         # test Python 2 version, all exchanges
